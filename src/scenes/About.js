      ...
      <div id='about' className='w-2/3 mx-auto py-20 md:py-20 md:grid grid-cols-[1fr,2fr]'>
        ...
        <div>
          <div className='flex flex-col gap-7 text-gray mb-8 text-sm md:text-xl'>
            <p>
            Мы команда Web-разработчиков. Мы занимаемся анализом ваших сильных сторон, чтобы отобразить их на вашем сайте. Это поможет вашим клиентам больше узнать о вас и вашей продукции, и повысить вашу узнаваемость.
            </p>
            <p>
            ...
            <p className='text-white'>
              Наша задача - сделать качественный сайт
            </p>
          </div>
